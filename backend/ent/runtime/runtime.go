...
func init() {
	...
	// groupDescOpenaiCompactRebalanceEnabled is the schema descriptor for openai_compact_rebalance_enabled field.
	groupDescOpenaiCompactRebalanceEnabled := groupFields[48].Descriptor()
	// group.DefaultOpenaiCompactRebalanceEnabled holds the default value on creation for the openai_compact_rebalance_enabled field.
	group.DefaultOpenaiCompactRebalanceEnabled = groupDescOpenaiCompactRebalanceEnabled.Default.(bool)
